...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    id: 3,
    name: 'Passtrie',
    imageUrls: ['../assets/passtrie-red berry.svg', '../assets/passtrie-pineapple.svg', '../assets/passtrie-cherry.svg'],
    price: 8,
    flavors: [
      { name: 'Red berry', color: '#E10F0F' },
      { name: 'Pineapple', color: '#00CACA' },
      { name: 'cherry', color: '#E91E63' },
    ],
    sizes: [Size.SMALL,Size.MEDIUM, Size.LARGE, Size.XL],
  },
];
